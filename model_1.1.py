...
load_dotenv()
#llm=ChatOpenAI(openai_api_key=os.getenv("OPENAI_API_KEY"),model_name="gpt-3.5-turbo-instruct",temperature=0.8)
...
def text_input():
    ...
    print("Summary is ")
    summerizer(res)
    print("Point Summary is ")
    point_summerizer(res)
    b=t_cont()
    if(b==1):
        text_input()
